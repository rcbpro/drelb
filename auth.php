...
$loginID		= "54PB5egZ";
$transactionKey = "48V258vr55AE8tcg";
$amount 		= "19.99";
...
echo "  <input type='hidden' name='x_receipt_link_URL' value='http://localhost/drelb' />";
echo "  <input type='hidden' name='x_relay_response' value='TRUE' />";
echo "  <input type='hidden' name='x_relay_url' value='http://www.drelb.com/auth.php' />";
echo "  <input type='submit' value='Click here for the secure payment' />";
echo "</FORM>";
echo "<pre>";
print_r($_POST);
echo "</pre>";
